...
-- Name: tb_products_category; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tb_products_category (
    product_i bigint NOT NULL,
...
--
-- TOC entry 4884 (class 2606 OID 16396)
...
--
-- TOC entry 4890 (class 2606 OID 16416)
...
--
-- TOC entry 4892 (class 2606 OID 16425)
...
-- Name: tb_products_category tb_products_category_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_products_category
    ADD CONSTRAINT tb_products_category_pkey PRIMARY KEY (product_i, category_id);


--
-- TOC entry 4896 (class 2606 OID 16441)
...
--
-- TOC entry 4898 (class 2606 OID 16447)
...
--
-- TOC entry 4901 (class 2606 OID 16467)
-- Name: tb_products_category fkg5rv22vllkwer0bw89eypmb41; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_products_category
    ADD CONSTRAINT fkg5rv22vllkwer0bw89eypmb41 FOREIGN KEY (product_i) REFERENCES public.tb_product(id);
...
-- Name: tb_products_category fkmlo20l7tdbomneb6hj8hco0td; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_products_category
    ADD CONSTRAINT fkmlo20l7tdbomneb6hj8hco0td FOREIGN KEY (category_id) REFERENCES public.tb_category(id);
...
-- Completed on 2025-12-17 18:00:07
